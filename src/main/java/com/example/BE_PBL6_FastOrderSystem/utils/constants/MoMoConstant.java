...
public class MoMoConstant {
    ...
    public static final String IPN_URL = "https://pbl6-fastordersystem.onrender.com:8080/api/v1/momo/ipn";
    public static final String CREATE_ORDER_URL = "https://test-payment.momo.vn/gw_payment/transactionProcessor";
    public static final String NOTIFY_URL = "https://pbl6-fastordersystem.onrender.com/api/v1/momo/notify";
