          ...
          child: Row(
            children: [
              GestureDetector(
                ...
                child: Icon(Icons.view_list,color: Colors.white,size: AppDimention.size40,),
              ),
              SizedBox(width: AppDimention.size20,),
              Text("Nguyễn Văn Nhật",style: TextStyle(fontSize: AppDimention.size20,color: Colors.white))
            ],
          ),
      );
    });
