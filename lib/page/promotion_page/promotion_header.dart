      ...
      return Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Text("Khuyến mãi",style: TextStyle(fontSize: AppDimention.size25,color: Colors.white,fontWeight: FontWeight.bold)),
            GestureDetector(
              onTap: (){
                Get.toNamed(AppRoute.CART_PAGE);
              },
              child: Icon(Icons.shopping_cart_outlined,size: AppDimention.size30,color: Colors.white,),
            )
          ],
        ),
      );
