                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.only(topLeft: Radius.circular(AppDimention.size10),topRight: Radius.circular(AppDimention.size10)),
                      ...
                      Row(
                        children: [
                          Container(
                            padding: EdgeInsets.only(left: AppDimention.size10,top: AppDimention.size10),
                            width:  AppDimention.screenWidth - AppDimention.size150,
                            height: AppDimention.size70,
                            child: Text("Combo hấp dẫn , khuyến mãi bất ngờ",style: TextStyle(fontSize: 16,color: Colors.white,fontWeight: FontWeight.bold),),
                          ),
                          GestureDetector(
                            onTap: (){
