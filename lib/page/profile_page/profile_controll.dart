      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            padding:
                EdgeInsets.only(top: AppDimention.size20 + AppDimention.size15),
            decoration: BoxDecoration(
              border: Border(
                top: BorderSide(
                  width: 1.0,
            ...
            child: Row(
              ...
              children: [
                GestureDetector(
                  onTap: () {
                    Get.find<OrderController>()
                        .getorderWithStatus("Đơn hàng đã được xác nhận");
                ...
                GestureDetector(
                  onTap: () {
                    Get.find<OrderController>()
                        .getorderWithStatus("Đang lấy hàng");
                ...
                GestureDetector(
                  onTap: () {
                    Get.find<OrderController>().getorderWithStatus("Đang giao");
                ...
                GestureDetector(
                  onTap: () {
                    Get.find<OrderController>()
                        .getorderWithStatus("Đã hoàn thành");
