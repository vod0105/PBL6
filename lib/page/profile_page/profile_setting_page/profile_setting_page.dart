...
class _ProfileSettingPageState extends State<ProfileSettingPage>{
  ...
  void _changePassword() {
    ...
    setState(() {
      if (password == "" || newpassword == "" || repassword == "") {
        ...
        _validateChangePasswordValue = "Mật khẩu phải chứa ít nhất một ký tự viết thường, viết hoa, số và ký tự đặc biệt";
        _showValidateChangePasswordForm = true;
  ...
  void _updateProfile(){
    String avatar = Get.find<UserController>().userprofile?.avatar == null ? defaultAvata : Get.find<UserController>().userprofile!.avatar!;
                          ...
                          child: Column(
                              children: [
                                Container(
                                  ...
                                  child: Stack(
                                    children: [
                                          ...
                                          child: Center(
                                              ...
                                              decoration: BoxDecoration(
                                                ...
                                                image: DecorationImage(
                                                  fit: BoxFit.cover,
                                                  image: MemoryImage(
                                                    base64Decode(userController.userprofile?.avatar == null ? defaultAvata :userController.userprofile!.avatar! )
                                                  )
                                                )
                                              ),
                                            ),
                                        ...
                                        Positioned(
                                          bottom: 0,
                                          left: AppDimention.screenWidth / 2 + AppDimention.size20,
                                          child: Container(
                                            ...
                                            child: Center(
                                              child:GestureDetector(
                                                ...
                                                child:  Icon(Icons.camera_alt,color: Colors.white,size: AppDimention.size30,),
                                              )
                                            ),
                                          ),
                                        )
                                ...
                                Container(
                                  width: AppDimention.screenWidth,
                                  child: Center(
                                    child: Text(userController.userprofile!.fullName!,style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold,color: Colors.white),),
                                  ),
                                )
                              ],
                                ...
                                child: TextField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      prefixIcon: IconButton(
                                        ...
                                        icon: Icon(Icons.location_on,color: AppColor.yellowColor,)
                                      ),
                              ...
                              child:Container(
                                ...
                                child: TextField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      prefixIcon: Icon(Icons.phone,color: AppColor.yellowColor,),
                                        ...
                                        child:Container(
                                          ...
                                          child: TextField(
                                              ...
                                              decoration: InputDecoration(
                                                ...
                                                prefixIcon: Icon(Icons.password,color: AppColor.yellowColor,),
                                    ...
                                    Container(
                                            ...
                                            child:Container(
                                              ...
                                              child: TextField(
                                                  ...
                                                  decoration: InputDecoration(
                                                    ...
                                                    hintStyle: TextStyle(color: Colors.grey[400]),
                                                    prefixIcon: Icon(Icons.commit_sharp,color: AppColor.yellowColor,),
                                        ...
                                        if(_showValidateChangePasswordForm)
                                          Container(
                                            ...
                                            child: Center(
                                              child: Text(_validateChangePasswordValue,style: TextStyle(color: Colors.redAccent),),
                                            ),
                                          ),
                                        SizedBox(height: AppDimention.size20,),
                                        Center(
