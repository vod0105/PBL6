  ...
  void _showDialogUpdate(CartData cartData) {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return Dialog(
          child: Container(
            width: AppDimention.screenWidth * .8,
                ...
                image: DecorationImage(
                  ...
                  image: Image.network(
                    ...
                    errorBuilder: (context, error, stackTrace) {
                      return Image.asset("assets/image/LoadingBg.png",
                          fit: BoxFit.cover);
                    },
                  ).image,
                )),
                              ...
                              child: Row(
                                children: [
                                    ...
                                    onChanged: (bool? value) {
                                      setState(() {
                                        ...
                                        if (value) {
                                          ...
                                          cartController.idSelectedStore
                                              .clear();
                                  ...
                                  SizedBox(
                                    ...
                                    child: Text(
                                      cartController.listCart[index].storeItem!
                                          .storeName!,
