...
class CartOrderState extends State<CartOrder> {
  ...
  Future<void> _order() async {
    ...
    if (paymentMethod.isEmpty ||
      ...
      cartController.orderAll(
          address, paymentMethod, latitude!, longitude!, selectedVoucherStr!);
              ...
              child: Column(
                children: [
                                                                ...
                                                                BoxDecoration(
                                                                    border: Border.all(
                                                                        ...
                                                                        color: const Color
                                                                            ...
                                                                            0)),
                                                                    borderRadius:
                                                                        BorderRadius.circular(AppDimention
                                                                            .size5),
                                                                    image:
                                                                        DecorationImage(
                                                                      fit: BoxFit
                                                                      ...
                                                                      image: Image
                                                                          .network(
                                                                        "${Appconstant.BASE_URL}/api/v1/public/uploads/images/${key ? productInCart!.image! : comboInCart!.image!}",
                  ...
                  Container(
                    ...
                    child: Text(
                        "Tổng : đ${_formatNumber(cartController.totalPrice)}"),
                  ),
                  ...
                  GetBuilder<PromotionController>(
                    builder: (controller) {
                      return controller.loadingByUser!
                          ? const CircularProgressIndicator()
                          : cartController.listCartInOrder.isNotEmpty &&
                                  controller
                                      .getByStoreIdAndUser(cartController
                                          .listCartInOrder[0]
                                          .storeItem!
                                          .storeId!)
                                      .isEmpty
                              ...
                              : Container(
                                  ...
                                  child: DropdownButtonFormField(
                                    ...
                                    items: controller.getVoucherByUser().map(
                                      (item) {
                                        return DropdownMenuItem(
                                          value: item,
                                          child: Container(
                                    ...
                                    selectedItemBuilder:
                                      ...
                                      return controller.listPromotion.map(
                                        (item) {
                                          return Container(
                                            alignment: Alignment.centerLeft,
                                            height: 60,
