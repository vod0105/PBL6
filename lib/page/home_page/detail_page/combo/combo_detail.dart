                            ...
                            child: Column(
                              children: [
                                ...
                                if (listDrink!.isNotEmpty)
                                  Column(
                                    children: listDrink!.map(
                                      (item) {
                                        // Check if the current item is selected
                                        bool isSelected = listDrinkSelected
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children:
                                  comboItem!.products!.map<Widget>((item) {
                                return Row(children: [
                                  Icon(
                                    Icons.circle,
