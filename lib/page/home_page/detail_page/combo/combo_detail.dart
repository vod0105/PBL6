                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Center(
                            child: Text(product.comboName,style: TextStyle(fontSize: AppDimention.size30,color: Colors.black)),
                          ),
                        ),
                        Container(
                          width: AppDimention.screenWidth,
                          margin: EdgeInsets.only(left: AppDimention.size20),
                           child: Text("Giá : ${product.price} vnđ",style: TextStyle(color: Colors.black,fontSize: 16,)),
                        ),
                        ...
                        child: Center(
                            child: GestureDetector(
                              ...
                              child: Container(
                                ...
                                child: Icon(Icons.arrow_back_ios_new,size:AppDimention.size20,),
                              ),
                            )
                        ),
                      ),
                      Container(
                        ...
                        child: Center(
                            child: Container(
                              ...
                              child: Icon(Icons.shopping_cart_outlined,size:AppDimention.size20,),
                            )
                        ),
                      ),
                    ],
